...
public:
    ...
    {
        return api().getConnectionVariableAsUInt64(client, flag);
    }

    double getDouble(ConnectionProperty flag) const
    {
        return api().getConnectionVariableAsDouble(client, flag);
    }

    QString getString(ConnectionProperty flag) const
    {
        return api().getConnectionVariableAsString(client, flag);
    }

    Client* client = Q_NULLPTR;
};
...
*/
uint64 ConnectionInfo::filetransferBandwidthSent() const
{
...
* How many bytes per second are currently being received by file transfers
*/
uint64 ConnectionInfo::filetransferBandwidthReceived() const
{
...
*/
time::milliseconds ConnectionInfo::ping() const
{
...
*/
time::milliseconds ConnectionInfo::idleTime() const
{
...
*/
uint64 ConnectionInfo::clientPort() const
{
...
*/
time::milliseconds ConnectionInfo::connectedTime() const
{
...
*/
uint64 ConnectionInfo::packetsSentSpeech() const
{
...
*/
uint64 ConnectionInfo::packetsSentKeepalive() const
{
...
*/
uint64 ConnectionInfo::packetsSentControl() const
{
...
*/
uint64 ConnectionInfo::packetsSentTotal() const
{
...
*/
uint64 ConnectionInfo::bytesSentSpeech() const
{
...
*/
uint64 ConnectionInfo::bytesSentKeepalive() const
{
...
*/
uint64 ConnectionInfo::bytesSentControl() const
{
...
*/
uint64 ConnectionInfo::bytesSentTotal() const
{
...
*/
uint64 ConnectionInfo::packetsReceivedSpeech() const
{
...
*/
uint64 ConnectionInfo::packetsReceivedKeepalive() const
{
...
*/
uint64 ConnectionInfo::packetsReceivedControl() const
{
...
*/
uint64 ConnectionInfo::packetsReceivedTotal() const
{
...
*/
uint64 ConnectionInfo::bytesReceivedSpeech() const
{
...
*/
uint64 ConnectionInfo::bytesReceivedKeepalive() const
{
...
*/
uint64 ConnectionInfo::bytesReceivedControl() const
{
...
*/
uint64 ConnectionInfo::bytesReceivedTotal() const
{
...
{
    uint64 result = d->getUInt64(ConnectionProperty::ConnectedTime);
}

void ConnectionInfo::cleanUp()
{
    api().cleanUpConnectionInfo(d->client);
}
