...
*/
class TEAMSPEAKSDK_EXPORT ISoundDevice
{
public:
...
inline TEAMSPEAKSDK_EXPORT QDebug operator<<(QDebug dbg, const ISoundDevice& a)
{
...
* \brief A device that can either playback or capture sound
*/
class TEAMSPEAKSDK_EXPORT SoundDevice : public ISoundDevice
{
public:
...
*/
class TEAMSPEAKSDK_EXPORT CustomDevice : public ISoundDevice
{
public:
